...
export declare type AnyFunc = (...values: any[]) => any;
 ...
 */
export declare type Diff<T extends object, U extends object> = Pick<T, Exclude<keyof T, keyof U>>;
/**
 * Pick props that exist in U
 */
export declare type Insersection<T extends object, U extends object> = Pick<T, Extract<keyof T, keyof U>>;
/**
 * $Diff of Flowtype
 * @example
 ...
 * // Expect { b: number } & { a?: string}
 */
export declare type WeakDiff<T extends object, U extends object> = Diff<T, U> & Partial<Insersection<T, U>>;
/**
 * Overwrite T by U
 *
 * @example
 ...
 *
 */
export declare type Assign<T extends object, U extends object> = Diff<T, U> & U;
/**
 * @example
 * type A = {a: string, b: number: c: number}
 * type T = MatchKeys<A, string> // "a"
 */
export declare type MatchKeys<T, Val> = ({
    [K in keyof T]: T[K] extends Val ? K : never;
})[keyof T];
/**
 * @example
 * type A = {a: string, b: number: c: number}
 ...
 */
export declare type UnMatchKeys<T, Val> = ({
    [K in keyof T]: T[K] extends Val ? never : K;
})[keyof T];
